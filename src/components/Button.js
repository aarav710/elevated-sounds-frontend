...
async function addToCart({ productId }) {
    let response = await fetch(`${REACT_APP_BACKEND_URL}/addToCart`, {
        method: 'POST',
        credentials: 'include',
        headers: {
...
async function buyNow({ productId }) {
    let response = await fetch(`${REACT_APP_BACKEND_URL}/buyItem`, {
        method: 'POST',
        credentials: 'include',
        headers: {
            'Content-Type': 'application/json',
...
async function deleteFromCart({ cartId }) {
    await fetch(`${REACT_APP_BACKEND_URL}/deleteFromCart`, {
        method: 'POST',
        credentials: 'include',
        headers: {
            'Content-Type': 'application/json',
